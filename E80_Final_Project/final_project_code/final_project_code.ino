...
// Depth Waypoints
double depth_waypoints[] = {0, 0.6, 1.2, 1.8, 2.4, 3, 2.4, 1.8, 1.2, 0.6, 0};// desired depths robot will stop at
...
void setup() {
  ...
  depth_control.init(number_depth_waypoints, depth_waypoints, 6000);
